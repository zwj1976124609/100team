...
class Register extends React.Component{
	...
	render(){
		return(
			...
			<b>推荐人手机号(选填)</b>
			<h3 className='st_tjh3'><input className='st_tj' type='text' placeholder='请输入邀请码' /></h3>
			<p className='st_p'></p>
			<h4><input type="checkbox"  /><p>我以阅读并同意<i>《用户注册协议》</i>和<em>《风险提示书》</em></p></h4>
			<h5><button className='st_stzc'>注册</button></h5>
			<h6><Link className='st_loginjk' to='/registerother'>借款账户注册</Link><Link className='st_loginh6' to='/login'>登录</Link></h6>
			</div>
